...
comment_1 = Comment.create({description: "Absolutely gorgeous!!😍😻💖👍", commentor_id: user_1.id, pin_id: pin_1.id})
comment_2 = Comment.create({description: "Gorgeous photo! How did you take this?", commentor_id: user_2.id, pin_id: pin_1.id})
comment_3 = Comment.create({description: "Absolutely gorgeous!!😍😻💖👍", commentor_id: user_1.id, pin_id: pin_2.id})
comment_4 = Comment.create({description: "Absolutely gorgeous!!😍😻💖👍", commentor_id: user_1.id, pin_id: pin_3.id})
comment_5 = Comment.create({description: "Absolutely gorgeous!!😍😻💖👍", commentor_id: user_1.id, pin_id: pin_4.id})
comment_6 = Comment.create({description: "Absolutely gorgeous!!😍😻💖👍", commentor_id: user_1.id, pin_id: pin_5.id})
comment_7 = Comment.create({description: "Gorgeous photo! How did you take this?", commentor_id: user_2.id, pin_id: pin_5.id})
comment_8 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_2.id, pin_id: pin_6.id})
comment_9 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_2.id, pin_id: pin_7.id})
comment_10 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_2.id, pin_id: pin_8.id})
comment_11 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_2.id, pin_id: pin_9.id})
comment_12 = Comment.create({description: "Gorgeous photo! How did you take this?", commentor_id: user_3.id, pin_id: pin_9.id})
comment_13 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_3.id, pin_id: pin_10.id})
comment_14 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_3.id, pin_id: pin_11.id})
comment_15 = Comment.create({description: "What software did you use? Photoshop? looks sooooooo good!", commentor_id: user_3.id, pin_id: pin_12.id})
comment_16 = Comment.create({description: "What software did you use? Photoshop? looks sooooooo good!", commentor_id: user_3.id, pin_id: pin_13.id})
comment_17 = Comment.create({description: "What software did you use? Photoshop? looks sooooooo good!", commentor_id: user_3.id, pin_id: pin_14.id})
comment_18 = Comment.create({description: "Gorgeous photo! How did you take this?", commentor_id: user_4.id, pin_id: pin_14.id})
comment_19 = Comment.create({description: "What software did you use? Photoshop? looks sooooooo good!", commentor_id: user_4.id, pin_id: pin_15.id})
comment_20 = Comment.create({description: "What software did you use? Photoshop? looks sooooooo good!", commentor_id: user_4.id, pin_id: pin_16.id})
comment_21 = Comment.create({description: "What software did you use? Photoshop? looks sooooooo good!", commentor_id: user_4.id, pin_id: pin_17.id})
comment_22 = Comment.create({description: "What software did you use? Photoshop? looks sooooooo good!", commentor_id: user_4.id, pin_id: pin_18.id})
comment_20 = Comment.create({description: "💓", commentor_id: user_4.id, pin_id: pin_19.id})
comment_21 = Comment.create({description: "i luv it !!!!! ", commentor_id: user_5.id, pin_id: pin_19.id})
comment_22 = Comment.create({description: "Gorgeous photo! How did you take this? i really want to go here!!", commentor_id: user_6.id, pin_id: pin_19.id})
comment_20 = Comment.create({description: "💓", commentor_id: user_6.id, pin_id: pin_20.id})
comment_21 = Comment.create({description: "💓", commentor_id: user_6.id, pin_id: pin_21.id})
comment_22 = Comment.create({description: "i luv it !!!!! ", commentor_id: user_6.id, pin_id: pin_21.id})
comment_23 = Comment.create({description: "💓", commentor_id: user_6.id, pin_id: pin_22.id})
comment_24 = Comment.create({description: "i luv it !!!!! ", commentor_id: user_6.id, pin_id: pin_23.id})
comment_25 = Comment.create({description: "i luv it !!!!! ", commentor_id: user_7.id, pin_id: pin_24.id})
comment_26 = Comment.create({description: "i luv it !!!!! ", commentor_id: user_7.id, pin_id: pin_25.id})
comment_27 = Comment.create({description: "i luv it !!!!! ", commentor_id: user_7.id, pin_id: pin_26.id})
comment_28 = Comment.create({description: "i luv it !!!!! ", commentor_id: user_7.id, pin_id: pin_27.id})
comment_29 = Comment.create({description: "i luv it !!!!! ", commentor_id: user_3.id, pin_id: pin_27.id})
comment_30 = Comment.create({description: "i luv it !!!!! ", commentor_id: user_7.id, pin_id: pin_28.id})
comment_31 = Comment.create({description: "This is the dream.", commentor_id: user_7.id, pin_id: pin_29.id})
comment_32 = Comment.create({description: "💓", commentor_id: user_7.id, pin_id: pin_30.id})
comment_33 = Comment.create({description: "This is the dream.", commentor_id: user_7.id, pin_id: pin_31.id})
comment_34 = Comment.create({description: "This is the dream.", commentor_id: user_3.id, pin_id: pin_32.id})
comment_35 = Comment.create({description: "💓", commentor_id: user_4.id, pin_id: pin_32.id})
comment_36 = Comment.create({description: "This is the dream.", commentor_id: user_5.id, pin_id: pin_33.id})
comment_37 = Comment.create({description: "This is the dream.", commentor_id: user_6.id, pin_id: pin_34.id})
comment_38 = Comment.create({description: "Absolutely gorgeous!!😍😻💖👍", commentor_id: user_1.id, pin_id: pin_35.id})
comment_39 = Comment.create({description: "Gorgeous photo! How did you take this?", commentor_id: user_2.id, pin_id: pin_36.id})
comment_40 = Comment.create({description: "Absolutely gorgeous!!😍😻💖👍", commentor_id: user_1.id, pin_id: pin_37.id})
comment_41 = Comment.create({description: "Absolutely gorgeous!!😍😻💖👍", commentor_id: user_1.id, pin_id: pin_38.id})
comment_42 = Comment.create({description: "Absolutely gorgeous!!😍😻💖👍", commentor_id: user_1.id, pin_id: pin_39.id})
comment_43 = Comment.create({description: "Absolutely gorgeous!!😍😻💖👍", commentor_id: user_1.id, pin_id: pin_40.id})
comment_44 = Comment.create({description: "Gorgeous photo! How did you take this?", commentor_id: user_2.id, pin_id: pin_41.id})
comment_45 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_2.id, pin_id: pin_42.id})
comment_46 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_2.id, pin_id: pin_43.id})
comment_47 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_2.id, pin_id: pin_44.id})
comment_48 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_2.id, pin_id: pin_45.id})
comment_49 = Comment.create({description: "Gorgeous photo! How did you take this?", commentor_id: user_3.id, pin_id: pin_46.id})
comment_50 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_3.id, pin_id: pin_47.id})
comment_51 = Comment.create({description: "WOW! I want to see it in the real life!!!💞👅", commentor_id: user_3.id, pin_id: pin_48.id})
comment_52 = Comment.create({description: "What software did you use? Photoshop? looks sooooooo good!", commentor_id: user_3.id, pin_id: pin_49.id})
comment_53 = Comment.create({description: "What software did you use? Photoshop? looks sooooooo good!", commentor_id: user_3.id, pin_id: pin_50.id})
comment_54 = Comment.create({description: "What software did you use? Photoshop? looks sooooooo good!", commentor_id: user_3.id, pin_id: pin_42.id})
